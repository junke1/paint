...
(function e(t, n, r) {
...
})(
  {
          ...
          t.CrayonBrush = t.util.createClass(t.BaseBrush, {
            ...
            set: function (i) {
              this._latest
                ...
                : (this._latest = new t.Point(i.x, i.y)),
          ...
          t.Drip = t.util.createClass(t.Object, {
            ...
            initialize: function (i, e, n, o, s) {
              (this.ctx = i),
                (this._point = e),
                (this._strokeId = s),
                (this.amount = t.util.getRandom(n, 0.5 * n)),
                (this.color = o),
            ...
            _update: function (i) {
              (this._lastPoint = t.util.object.clone(this._point)),
                ...
                (this.life -= 0.05),
                t.util.getRandom() < 0.03
                  ? (this.rate += t.util.getRandom(0.03, -0.03))
                  : t.util.getRandom() < 0.05 && (this.rate *= 0.01);
            },
            _draw: function () {
              this.ctx.save(),
                this.line(
                ...
                : 10 > o &&
                  ...
                  (this._drips.push(
                    new t.Drip(
                      ...
                      n,
                      t.util.getRandom(0.25 * this.size, 0.1 * this.size),
                      this.color,
                      this._strokeId
                    )
                  ),
            ...
            _render: function (i) {
              ...
              for (
                n = this.canvas.contextTop,
                  n.beginPath(),
                  s = 0,
                  len = this._size / this._lineWidth / 2;
                s < len;
                s++
              )
                (o = (this._lineWidth - 1) * s),
                  (n.globalAlpha = 0.8 * this.opacity),
    ...
    5: [
      function (require, module, exports) {
        !(function (s) {
          s.SprayBrushCustom = s.util.createClass(s.BaseBrush, {
            color: "#000000",
            opacity: 1,
            width: 30,
            _baseWidth: 40,
            ...
            _render: function () {
              function A() {
                ...
                (t = new s.Point(B._point.x || 0, B._point.y || 0)),
                  ...
                  B.canvas._isCurrentlyDrawing
                    ? setTimeout(A, B._interval)
                    : B._reset();
              }
              var B = this;
        ...
        !(function (t) {
          t.Stroke = t.util.createClass(t.Object, {
            ...
            update: function (i, n, o) {
              (this._lastPoint = t.util.object.clone(this._point)),
                (this._point = this._point.addEquals({ x: n.x, y: n.y }));
        ...
        !(function (t) {
          (t.Point.prototype.angleBetween = function (t) {
            ...
            (t.Point.prototype.normalize = function (t) {
              ...
              return (
                i > 0 &&
                  ((this.x = (this.x / i) * t), (this.y = (this.y / i) * t)),
                this
              );
            });
        })(fabric);
